...
<div class="py-2 px-6 sticky top-[50px] flex gap-6 justify-between items-center bg-[#f6f9fb] z-10 container-shadow">
    <ul class="list-none flex items-center">
        ...
        <img src="{{asset ('public/assets/images/svg/arrow-right.svg')}}" alt="home" class="w-6 h-6 ">
            ...
            <span class="text-[#116aef] text-sm">Roles</span>
        </li>
    </ul>
</div>
<div class="sm:p-6 p-4">
    ...
    <div class="bg-white p-4 rounded-lg w-full container-shadow mb-4">
        <div class="flex flex-wrap gap-5 justify-between items-center md:pb-8 pb-4">
            <h5 class="text-lg font-medium leading-5 text-[#272727]">Role List</h5>
            <a href="{{url('role-with-permissions/add')}}"
                class="text-white bg-[#116aef] rounded-md py-1.5 px-3 text-sm links-shadow">
                Add Role
            </a>
        </div>
        <div class="rounded-md overflow-hidden border border-[#cdd6dc] w-full">
            <div class="w-full overflow-x-auto">
                @if($roles->isEmpty())
                <p class="text-red-500 text-center">No roles found.</p>
                @else
                <table
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="p-2 truncate">{{$role->name}}</td>
                            <td class="p-2 truncate">
                                <div class="flex items-center gap-1">
                                    <a href='{{ url("role-with-permissions/$role->id/edit") }}'
                                    ...
                                    <a href='{{ url("role-with-permissions/$role->id/delete") }}'
